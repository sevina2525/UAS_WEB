...
<nav class="navbar navbar-expand-lg nav-light bg-light" aria-label="Light offcanvas navbar">
    ...
    <div class="main">
    <h1 class="mb-3 mb-md-0 text-muted">DATA KECANTIKAN</h1> <br>
    <a href="add_kecantikan.php"><button type="submit"><h3>Tambah Data +</h3></button></a><br><br>
    <form class="form-inline" >
        ...
        ?>
            ...
            <tr class="table-info">
                ...
                <td>
                <a href="edit.php?id_kecantikan=<?=$row['id_kecantikan'];?>">
                ...
                <br>
                <br>
                <a href="hapus.php?id_kecantikan=<?=$row['id_kecantikan'];?>">
    ...
    <?php
        ...
        if($kolomCari=="" && $kolomKataKunci==""){
        ?>
          <a href="admin_data_kecantikan.php?page=<?php echo $LinkPrev; ?>">Previous</a>
     <?php     
        }else{
      ?> 
        <a href="admin_data_kecantikan.php?Kolom=<?php echo $kolomCari;?>&KataKunci=<?php echo $kolomKataKunci;?>&page=<?php echo $LinkPrev;?>">Previous</a>
       <?php
         } 
      }
    ?>
    ...
    <?php
      ...
      for($i = $startNumber; $i <= $endNumber; $i++){
        ...
        if($kolomCari=="" && $kolomKataKunci==""){
    ?>
        <?php $linkActive; ?><a href="admin_data_kecantikan.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>

    <?php
      }else{
        ?>
        <?php $linkActive; ?><a href="admin_data_kecantikan.php?Kolom=<?php echo $kolomCari;?>&KataKunci=<?php echo $kolomKataKunci;?>&page=<?php echo $i; ?>"><?php echo $i; ?></a>
        <?php
      }
    }
    ?>
    ...
    if($kolomCari=="" && $kolomKataKunci==""){
      ?>
        <a href="admin_data_kecantikan.php?page=<?php echo $linkNext; ?>">Next</a>
    <?php     
      }else{
    ?> 
        <li><a href="admin_data_kecantikan.php?Kolom=<?php echo $kolomCari;?>&KataKunci=<?php echo $kolomKataKunci;?>&page=<?php echo $linkNext; ?>">Next</a></li><br>
  <?php
    }
  }
  ?>
