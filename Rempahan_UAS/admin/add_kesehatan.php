...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if(move_uploaded_file($tmp, './konten/' . $gambar_baru)){
            ...
            $sql_upload = mysqli_query($conn,"INSERT INTO `kesehatan`(`judul`, `gambar`, `deskripsi`,`resep`,`tanggal`) VALUES ('".$judul."','".$gambar_baru."','".$deskripsi."','".$resep."','".$tanggal."')");
            if($sql_upload){
...
<h1 class="h3 mb-3 fw-normal"><b>Add Data Kesehatan</b></h1>
