...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if(move_uploaded_file($tmp, './konten/' . $gambar_baru)){
            ...
            $sql_upload = mysqli_query($conn,"INSERT INTO `kecantikan`(`judul`, `gambar`, `deskripsi`,`resep`,`tanggal`) VALUES ('".$judul."','".$gambar_baru."','".$deskripsi."','".$resep."','".$tanggal."')");
            if($sql_upload){
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <nav class="navbar navbar-expand-lg nav-light bg-light" aria-label="Light offcanvas navbar">
        ...
        <h2 class="navbar-brand" href="#"><b>Admin RempahanRempah</b></h2>
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbarLight" aria-labelledby="offcanvasLightLabel">
                <div class="offcanvas-header">
                    <h2 class="offcanvas-title" id="offcanvasNavbarLightLabel"><b>Menu</b></h2>
                </div>
